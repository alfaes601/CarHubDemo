          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              <Transition.Child
                ...
                leave="ease-in duration-100 scale-100"
                leaveTo="opacity-0 scale-95"
              >
                <Dialog.Panel
                  className="reative w-full max-w-lg max-h-[90vh] 
                overflow-y-auto transform rounded-2xl bg-white p-5 text-left shadow-xl
